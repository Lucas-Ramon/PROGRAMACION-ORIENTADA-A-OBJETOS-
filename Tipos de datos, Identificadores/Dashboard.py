...
def mostrar_codigo(ruta_script):
    """Muestra el código del script especificado."""
...
def ejecutar_codigo(ruta_script):
    """Ejecuta el script especificado en una nueva ventana de terminal."""
    try:
...
def mostrar_menu():
    """Muestra el menú principal y permite seleccionar una unidad."""
...
def mostrar_sub_menu(ruta_unidad):
    """Muestra las subcarpetas disponibles en la unidad seleccionada."""
